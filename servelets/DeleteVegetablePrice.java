...
public class DeleteVegetablePricepackage com.david.servlets;
...
/**
 * Servlet implementation class DeleteVegetablePrice
 */

public class DeleteVegetablePrice extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException
        {
            ...
            System.out.println("Made a connection");
                ...
                //Create Query
            String query = "delete from vegetable_price where autoid="+id+"";
